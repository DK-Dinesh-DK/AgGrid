...
function HeaderRenderer({
  ...
  if (!(column.sortable || column.filter)) return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: column.headerName ?? alterHeaderName
  });
  if (column.sortable && !column.filter) return /*#__PURE__*/jsxRuntime.jsx(SortableHeaderCell, {
    onSort: onSort,
  ...
  if (column.filter && !column.sortable) return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
  ...
  if (column.filter && column.sortable) return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
...
function FilterRenderer({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [!column.sortable && /*#__PURE__*/jsxRuntime.jsx("span", {
      className: headerSortNameClassname,
      children: column.headerName ?? alterHeaderName
...
function DataGrid(props, ref) {
  ...
  function contextMenuRowRenderer(key, props) {
    return /*#__PURE__*/jsxRuntime.jsx(reactContextmenu.ContextMenuTrigger, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(RowComponent, _extends({}, props))
    }, key);
  }
  ...
  var _useState4 = react.useState(defaultColumnOptions),
    defaultColumnDef = _useState4[0],
    setDefaultColumnDef = _useState4[1];
  var _useState5 = react.useState(raawGroupBy),
  ...
  var _useState10 = react.useState(initialPosition),
  ...
  var _useState15 = react.useState(raawRows),
    rawRows = _useState15[0],
    setRawRows = _useState15[1];
  var _useState16 = react.useState(serialNumber ? [SerialNumberColumn].concat(raawColumns) : raawColumns),
    rawColumns = _useState16[0],
    setRawColumns = _useState16[1];
  var _useState17 = react.useState(tablePagination),
    pagination = _useState17[0],
    _setPagination = _useState17[1];
  var _useState18 = react.useState(suppressPaginationPanel != null ? suppressPaginationPanel : false),
    suppressPagination = _useState18[0];
    _useState18[1];
  var _useState19 = react.useState(paginationPageSize != null ? paginationPageSize : 20),
    size = _useState19[0],
    setSize = _useState19[1];
  var _useState20 = react.useState(defaultPage != null ? defaultPage : 1),
  ...
  var _useState21 = react.useState(_extends({}, defaultFilters, {
      enabled: true
    })),
  ...
  var _useCalculatedColumns = useCalculatedColumns({
    ...
    groupBy = _useCalculatedColumns.groupBy;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [props.export && /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [props.export.csvFileName && /*#__PURE__*/jsxRuntime.jsx(ExportButton, {
        onExport: function onExport() {
          return exportDataAsCsv(props.export.csvFileName);
        },
        children: "Export to CSV"
      }), props.export.excelFileName && /*#__PURE__*/jsxRuntime.jsx(ExportButton, {
        onExport: function onExport() {
          return exportDataAsExcel(props.export.excelFileName);
        },
        children: "Export to XSLX"
      }), props.export.pdfFileName && /*#__PURE__*/jsxRuntime.jsx(ExportButton, {
        onExport: function onExport() {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(DataGridDefaultComponentsProvider, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(HeaderRow$1, {
            ...
            children: [topSummaryRows == null ? void 0 : topSummaryRows.map(function (row, rowIdx) {
              ...
              return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
                children: /*#__PURE__*/jsxRuntime.jsx(SummaryRow$1, {
          ...
          children: contextMenuItems.map(function (item) {
            ...
            return ((_item$subMenu = item.subMenu) == null ? void 0 : _item$subMenu.length) > 0 ? /*#__PURE__*/jsxRuntime.jsx(reactContextmenu.SubMenu, {
              ...
              children: item.subMenu.map(function (subItem) {
                return /*#__PURE__*/jsxRuntime.jsx(reactContextmenu.MenuItem, {
                  onClick: subItem.action,
                  children: subItem.name
                });
              })
            }) : /*#__PURE__*/jsxRuntime.jsx(reactContextmenu.MenuItem, {
              onClick: item.action,
              children: item.name
            });
          })
      ...
      }) : undefined, pagination && !suppressPagination && /*#__PURE__*/jsxRuntime.jsx(Pagination, {
