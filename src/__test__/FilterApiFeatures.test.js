...
describe('GridAPI - Filtering APIs', () => {
    ...
    test('getFilterModel,setFilterModel work correctly', () => {
        const filterString = "high"
        const initialFilterModel = { id: '', task: '', priority: '', undefined: '', enabled: true }
        const expectedFilterModel={ id: '', task: 'Task #2', priority: '', undefined: '', enabled: true }   
        render(<LaiDatagrid filterString={filterString} filterModel={{ task: "Task #2" }} />)
