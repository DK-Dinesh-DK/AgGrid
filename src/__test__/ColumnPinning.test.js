import { render, act, screen, fireEvent, queryAllByRole } from "@testing-library/react";
...
describe('Column Pinning', () => {
    test('setColumnPinned works correctly when column passed as string', () => {
        ...
        expect(taskColumn).toHaveClass('rdg-cell-frozen rdg-cell-frozen-last')
    })
    ...
    test('setColumnsPinned works correctly when columns are passed as array of strings', () => {
        ...
        expect(idColumn).toHaveClass('rdg-cell-frozen')

        expect(priorityColumn).toBeInTheDocument()
        expect(priorityColumn).toHaveClass('rdg-cell-frozen rdg-cell-frozen-last')
    })
