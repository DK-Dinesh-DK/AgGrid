  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          dataGridRef.current.api.setCellValue(
            props.rowIndex,
            props.colKey,
            props.newValue
          )
      ...
      <button
        ...
        onClick={() => dataGridRef.current.api.updateColumns(props.newColumns)}
      >
        updateColumns
      </button>
      <button
        ...
        onClick={() => dataGridRef.current.api.setColumnDefs(props.setColumns)}
      >
        setColumnDefs
      </button>
      <button
        ...
        onClick={() =>
          (getRowNodeOutput = dataGridRef.current.api.getRowNode(
            props.rowIndex
          ))
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (getValueOutput = dataGridRef.current.api.getValue(
            props.colKey,
            props.rowNode
          ))
        }
      ...
      <button
        ...
        onClick={() =>
          (getFirstRenderedDataOutput =
            dataGridRef.current.api.getFirstRenderedData())
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (getDisplayedRowAtIndexOutput =
            dataGridRef.current.api.getDisplayedRowAtIndex(props.rowIndex))
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (getDisplayedRowCountOutput =
            dataGridRef.current.api.getDisplayedRowCount())
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (getFirstDisplayedRowOutput =
            dataGridRef.current.api.getFirstDisplayedRow())
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (getLastDisplayedRowOutput =
            dataGridRef.current.api.getLastDisplayedRow())
        }
      >
        getLastDisplayedRow
      </button>
      ...
      <button
        ...
        onClick={() => (getRowsOutput = dataGridRef.current.api.getRows())}
      >
        getRows
      </button>
      <button
      ...
      <button
        ...
        onClick={() => (getModelOutput = dataGridRef.current.api.getModel())}
      >
        getModel
      </button>
      <DataGrid
...
describe("GridAPI", () => {
  test("setCellValue and getFirstRenderedData work correctly", () => {
    ...
    render(<LaiDatagrid rowIndex={2} colKey={"task"} newValue="Coding" />);

    const datagrid = screen.getByTestId("laidatagrid");
    expect(datagrid).toBeInTheDocument();

    const getFirstRenderedDataBtn = screen.queryByTestId(
      "getFirstRenderedDataBtn"
    );
  ...
  test("getColumnDefs,setColumnDefs and updateColumns work correctly", () => {
    ...
    const columnDefsAfterSetColumns = [
      {
        children: false,
        depth: 0,
        field: "id",
  ...
  test("getDisplayedRowCount,getDisplayedRowAtIndex,getFirstDisplayedRow and getLastDisplayedRow work correctly", () => {
    ...
    const getDisplayedRowCountBtn = screen.queryByTestId(
      "getDisplayedRowCountBtn"
    );
    ...
    const getFirstDisplayedRowBtn = screen.queryByTestId(
      "getFirstDisplayedRowBtn"
    );
    ...
    const getLastDisplayedRowBtn = screen.queryByTestId(
      "getLastDisplayedRowBtn"
    );
    ...
    const getDisplayedRowAtIndexBtn = screen.queryByTestId(
      "getDisplayedRowAtIndexBtn"
    );
  ...
  test("getRows, getRenderedrows, getRenderedNodes and getModel work correctly", () => {
    ...
    expect(getRenderedNodesOutput).toEqual(
      expect.arrayContaining(expectedRenderedNodes)
    );
    ...
    expect(getModelOutput.getRowNode(3)[0]).toEqual(
      expect.objectContaining(expectedRenderedNodes[2])
    );
    ...
    expect(getModelOutput.getRowBounds(3)).toEqual({
      rowTop: 72,
      rowHeight: 24,
    });
  });
