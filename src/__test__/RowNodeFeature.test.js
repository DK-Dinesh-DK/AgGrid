  ...
  return (
    <>
      <button
        ...
        onClick={() => {
          console.log(gridlocalRef.current.api.getRowNode(2).isSelected());
        }}
      >
        isSelected
      </button>
      <button
        ...
        onClick={() => {
          gridlocalRef.current.api.getRowNode(2).setSelected();
        }}
      >
        setSelected
      </button>
      <button
        data-testid={"setData"}
        onClick={() => {
          gridlocalRef.current.api.getRowNode(4).setData({
            id: 4,
            name: `supplier-4-0`,
            format: `package-4-0`,
            position: "Run of site",
  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={() => {
          dataGridRef.current.api.getRowNode(2).isExpandable();
        }}
      >
        isExpandable
      </button>
      <button
        ...
        onClick={() => {
          dataGridRef.current.api.getRowNode(2).setExpanded(expended);
