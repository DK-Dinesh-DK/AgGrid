  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          (displayNameForColumnOutput =
            dataGridRef.current.columnApi.getDisplayNameForColumn(
              props.displayNameForColumnId,
              props.displayNameForColumnLocation
            ))
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (displayedColAfterOutput =
            dataGridRef.current.columnApi.getDisplayedColAfter(
              props.displayedColAfterColumnId
            ))
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (displayedColBeforeOutput =
            dataGridRef.current.columnApi.getDisplayedColBefore(
              props.displayedColBeforeColumnId
            ))
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (allVirtualColumnsOutput =
            dataGridRef.current.columnApi.getAllDisplayedVirtualColumns())
        }
      >
      ...
      <button
        ...
        onClick={() =>
          (allDisplayedColumnsOutput =
            dataGridRef.current.columnApi.getAllDisplayedColumns())
        }
      >
...
describe("Display name column apis", () => {
  test("getDisplayNameForColumn works correctly", () => {
    ...
    const getDisplayNameForColumnBtn = screen.queryByTestId(
      "getDisplayNameForColumnBtn"
    );
  ...
  test("getDisplayedColAfter works correctly", () => {
    render(
      <LaiDatagrid displayedColAfterColumnId={{ colId: columns[1].field }} />
    );
    ...
    const getDisplayedColAfterBtn = screen.queryByTestId(
      "getDisplayedColAfterBtn"
    );
  ...
  test("getDisplayedColBefore works correctly", () => {
    render(
      <LaiDatagrid displayedColBeforeColumnId={{ colId: columns[1].field }} />
    );
    ...
    const getDisplayedColBeforeBtn = screen.queryByTestId(
      "getDisplayedColBeforeBtn"
    );
  ...
  test("getAllDisplayedVirtualColumns works correctly", () => {
    ...
    const getAllDisplayedVirtualColumnsBtn = screen.queryByTestId(
      "getAllDisplayedVirtualColumnsBtn"
    );
    ...
    expect(allVirtualColumnsOutput).toEqual(
  ...
  test("getAllDisplayedColumns works correctly", () => {
    ...
    const getAllDisplayedColumnsBtn = screen.queryByTestId(
      "getAllDisplayedColumnsBtn"
    );
    ...
    expect(allDisplayedColumnsOutput).toEqual(
      expect.arrayContaining([
